...
<div class="flex-1 bg-gray-100 min-h-screen p-4">  
  <!-- Content -->
  <div class="container bg-gray-100 mx-auto mb-4">
      <!-- Dashboard Content -->
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <!-- Card 1 -->
        <div class=" overflow-x-auto bg-blue-400 pt-4" style="border-radius: 10px;">
        ...
        <div class=" overflow-x-auto bg-blue-400 pt-4" style="border-radius: 10px;">
            <div class="grid grid-cols-2  bg-white p-4 rounded-lg shadow">
                ...
                <div class="grid grid-rows-1">
                    <div>
                        <div class="p-2 bg-gradient-to-r from-pink-500 to-pink-700 text-white text-center" style="border-radius: 10px;">
                            TOTAL MAHASISWA
                         </div>
                        <div class="text-4xl text-gray-700 text-center pt-2">
                            <p>{{ $mahasiswa ->count()}}</p>
