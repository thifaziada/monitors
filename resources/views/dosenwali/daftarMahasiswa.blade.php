...
<div class="flex-1 min-h-screen p-4">  
  ...
  <div class="container mx-auto p-2"> <!-- Added p-4 for padding -->
    <div class="container mx-auto">
      <h1 class="font-bold text-xl mb-4">List Mahasiswa Perwalian</h1>
    </div>

    <form action="{{ route('dosenwali.daftarMahasiswa') }}" method="GET" class="mb-4">
        <div class="flex items-center">
            <input type="text" name="search" placeholder="Cari mahasiswa..." class="px-2 py-1 border rounded">
